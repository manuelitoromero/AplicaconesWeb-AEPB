...
<div class="row">
  ...
  <div class="large-4 columns">
    <label for="Enfermedades">Enfermedades:</label>
      ...
      <br>
      <input name="trasladoreincorpoacion" type="text" id="trasladoreincorpoacion" placeholder="Traslado / Reincorporación" value="no<?php echo $this->input->post('trasladoreincorpoacion'); ?>" size="20" /> 
