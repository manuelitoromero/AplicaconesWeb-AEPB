...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <div class="button-bar right">
			  ...
			  <ul class="button-group">
			    <li><?=anchor('oficios/listadeasistencia/'.$clave_materia.'/'.$this->user->mi_join($clave_materia,'materias','clave_especialidad','semestre'), 'Lista de Asistencias','target="_blank" class="small button"')?></li>
			    <li><?=anchor('oficios/listaevaluacionespaciales/'.$clave_materia.'/'.$this->user->mi_join($clave_materia,'materias','clave_especialidad','semestre'), 'Evaluaciones Parciales','target="_blank" class="small button"')?></li>
			    <li><?=anchor('oficios/formatolistadeevaluacion/'.$clave_materia.'/0/'.$this->user->mi_join($clave_materia,'materias','clave_especialidad','semestre'), 'Evaluación Final','target="_blank" class="small button"')?></li>

          <li><?=anchor('oficios/formatolistadeevaluacion/'.$clave_materia.'/1/'.$this->user->mi_join($clave_materia,'materias','clave_especialidad','semestre'), '1°','target="_blank" class="small button"')?></li>
          <li><?=anchor('oficios/formatolistadeevaluacion/'.$clave_materia.'/2/'.$this->user->mi_join($clave_materia,'materias','clave_especialidad','semestre'), '2°','target="_blank" class="small button"')?></li>
          <li><?=anchor('oficios/formatolistadeevaluacion/'.$clave_materia.'/3/'.$this->user->mi_join($clave_materia,'materias','clave_especialidad','semestre'), '3°','target="_blank" class="small button"')?></li>
          <?php if ($lic == 5){ ?>
          <li><?=anchor('oficios/formatolistadeevaluacion/'.$clave_materia.'/4/'.$this->user->mi_join($clave_materia,'materias','clave_especialidad','semestre'), '4°','target="_blank" class="small button"')?></li>
			   <?php } ?>
        </ul>
			</div>
            </div>
