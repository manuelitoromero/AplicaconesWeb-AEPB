...
<div class="row">
    ...
    <?php if($error == "si"){ ?>
            <div data-alert class="alert-box alert">
              Nota: No se creo el alumno que intento dar de alta!  El Alumno ya existia y sus datos son... 
          ...
          <tr>
            <td colspan="2" align="center" bgcolor="#FFFFFF"><table width="800" border="0" cellspacing="0" cellpadding="0">
              ...
              <table width="800" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td bgcolor="#FFFFFF">Traslado / Reincorporación</td>
                  <td bgcolor="#F9F9F9"><?=$dt_alumno['0']->trasladoreincorpoacion;?></td>
                </tr>
              </table>
              <br />
              <? if($idsession >= "3"){ ?>
